<nav class="navbar navbar-expand-lg bg-black fs-6 shadow-lg">
              ...
              <ul class="navbar-nav gap-3 align-items-center">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="#">Film à sketchs</a></li>
                    <li><a class="dropdown-item" href="#">Found Footage</a></li>
